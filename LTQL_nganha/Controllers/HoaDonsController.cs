...
namespace LTQL_nganha.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
